...
🌱 My first published repository was a [child theme](https://github.com/felixhahnweilheim/humhub-themes-orange) for Humhub. But with the latest update (HumHub 1.18) you might not need a custom theme anymore. You can now set the most important colors in the administration interface. Alternatively I'd recommend the Clean Theme.
